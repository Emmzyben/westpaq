...
export function Sidebar({ isOpen, setIsOpen, onLogout }) {
  ...
  return (
    <>
      ...
      <aside
        className={`w-60 flex-shrink-0 bg-white border-r flex flex-col p-4 fixed md:sticky top-0 h-screen z-50 transition-transform ${isOpen ? "translate-x-0" : "-translate-x-full"
          } md:translate-x-0`}
